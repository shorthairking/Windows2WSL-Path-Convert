...
> 若直接使用已构建好的 `target/release/wpc` 发布二进制，则无需 Rust 工具链。

### 编码说明（UTF-8）

项目所有文件均为 **UTF-8 编码**。若中文显示乱码（如中文错误提示或中文文档），请确认终端语言环境为 UTF-8：

```bash
echo "$LANG"                       # 应包含 UTF-8，如 C.UTF-8 / en_US.UTF-8
export LANG=C.UTF-8                # 如需要可加入 ~/.bashrc
```
...
| 文档 | 英文版（主） | 简体中文 |
|------|--------------|----------|
| 开发方案 | [`docs/development-plan.md`](docs/development-plan.md) | [`docs/development-plan.zh-CN.md`](docs/development-plan.zh-CN.md) |
| 架构说明 | [`docs/architecture.md`](docs/architecture.md) | [`docs/architecture.zh-CN.md`](docs/architecture.zh-CN.md) |
| 冒烟与验收记录 | [`docs/smoke-checklist.md`](docs/smoke-checklist.md) | [`docs/smoke-checklist.zh-CN.md`](docs/smoke-checklist.zh-CN.md) |
| 测试计划 | [`docs/test-plan.md`](docs/test-plan.md) | [`docs/test-plan.zh-CN.md`](docs/test-plan.zh-CN.md) |
| 项目约定 | [`AGENTS.md`](AGENTS.md) | [`AGENTS.zh-CN.md`](AGENTS.zh-CN.md) |
